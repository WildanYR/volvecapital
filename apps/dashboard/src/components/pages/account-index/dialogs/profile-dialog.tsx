...
export function PagesAccountIndexDialogProfile({ open, selectedAccount, onOpenChange}: { open?: boolean, selectedAccount?: Account, onOpenChange: (value: boolean) => void }) {
  ...
  return (
    <>
      ...
      <PagesAccountIndexDialogEditProfile open={dialogAccountProfileOpen} onOpenChange={setDialogAccountProfileOpen} selectedAccountProfile={selectedAccountProfile} selectedAccountId={account?.id} />
