              ...
              <div className="p-4 space-y-4">
                {isLoading ? (
                  ...
                  <div className="space-y-3">
                    {/* Initial Capital (from account.capital_price if exists) */}
                    {account.capital_price > 0 && (
                      <div className="flex justify-between items-center p-3 bg-secondary/20 rounded-md border-l-4 border-secondary">
                        <div>
                          <p className="text-sm font-bold">{formatRupiah(account.capital_price)}</p>
