            ...
            return (
              ...
              >
                ...
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className={`group p-8 rounded-3xl flex flex-col h-full relative border transition-all duration-500 hover:-translate-y-4 pointer-events-none ${
                    isFeatured 
                ...
                >
                  ...
                  <div className="space-y-3 flex-grow mb-10 pointer-events-auto">
