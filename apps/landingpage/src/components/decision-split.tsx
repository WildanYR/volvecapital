    ...
    <section className="py-24 bg-slate-50 relative z-10">
      <div ref={ref} className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-5xl font-black text-[#0f172a] tracking-tight reveal-hidden delay-100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          >
            ...
            <Link
              href="/redeem"
              className="w-full py-5 bg-[#0f172a] text-white font-black rounded-2xl flex items-center justify-center gap-3 hover:bg-slate-800 hover:scale-105 transition-all shadow-xl group-hover:shadow-orange-500/10 active:scale-95"
            >
