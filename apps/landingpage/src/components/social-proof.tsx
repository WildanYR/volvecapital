...
export function SocialProof({ config }: SocialProofProps) {
  ...
  const defaultStats = [
    { id: 'default-1', number: '94.469+', label: 'Transaksi Berhasil', icon: Users },
    { id: 'default-2', number: '4.9/5', label: 'Rating Layanan', icon: Star, fill: true },
    { id: 'default-3', number: '24/7', label: 'Sistem Otomatis', icon: Sparkles },
  ]
