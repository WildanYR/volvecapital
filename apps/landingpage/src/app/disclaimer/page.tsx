  ...
  return (
    <main className="min-h-screen flex flex-col bg-background text-foreground">
      ...
      <div className="pt-40 pb-20 px-6 container mx-auto max-w-4xl">
        ...
        >
          <section>
            <h2 className="text-2xl font-black text-foreground uppercase tracking-tight mb-4">1. Hubungan dengan Penyedia Layanan</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-black text-foreground uppercase tracking-tight mb-4">2. Ketersediaan Layanan</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-black text-foreground uppercase tracking-tight mb-4">3. Kebijakan Pihak Ketiga</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-black text-foreground uppercase tracking-tight mb-4">4. Akurasi Informasi</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-black text-foreground uppercase tracking-tight mb-4">5. Batasan Tanggung Jawab</h2>
            <p>
