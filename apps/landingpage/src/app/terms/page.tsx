      ...
      <div className="pt-40 pb-32 px-6 container mx-auto max-w-4xl">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-primary/10 border border-primary/20 mb-6">
            ...
            <span className="text-[10px] font-black tracking-[0.3em] text-primary uppercase">Dokumen Legal</span>
          </div>
          <h1 className="text-4xl md:text-7xl font-black mb-6 tracking-tight text-foreground">
            Syarat & <span className="bg-clip-text text-transparent bg-gradient-to-br from-primary to-primary/80">Ketentuan.</span>
          </h1>
          <p className="text-muted-foreground font-bold uppercase tracking-widest text-xs">Terakhir diperbarui: 2 Mei 2026</p>
        </motion.div>
        ...
        >
          ...
          <section className="p-8 md:p-12 bg-background rounded-[40px] border border-border shadow-sm transition-all hover:shadow-md">
            <h2 className="text-2xl font-black text-foreground uppercase tracking-tight mb-6 flex items-center gap-4">
              <span className="size-10 rounded-xl bg-primary/10 flex items-center justify-center text-primary font-black text-sm">04</span>
              Pembayaran & Refund
            </h2>
